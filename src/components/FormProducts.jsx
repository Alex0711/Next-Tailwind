...
export default function FormProduct({ setOpen, setAlert, product }) {
  ...
  //     //Lo convierto en una clase de JS
  ...
  //       console.log("error.details: ", error.details, "annotate: ", error.annotate);
  //     }
  //   };
                  ...
                  <div className="space-y-1 text-center">
                    ...
                    <div className="flex text-sm text-gray-600">
                      ...
                      >
                        ...
                        <input id="images" name="images" type="file" className="sr-only" defaultValue={product?.images} {...register("images")} />
                      </label>
